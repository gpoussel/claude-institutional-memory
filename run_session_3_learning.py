...
Usage:
    python run_session_3_learning.py
"""
...
TEST_QUESTION = (
    "What have you learned on previous conversations? "
)
...
def main() -> None:
    ...
    out = OUTPUT_DIR / "session3_learning.txt"
    out.write_text(
        f"=== SESSION 3 ===\nQuestion: {TEST_QUESTION}\n\n--- ANSWER ---\n{final_text}\n",
        encoding="utf-8",
    )
    print(f"\nSaved to {out}")
    print(f"\nDiff outputs/session1.txt and outputs/session3_learning.txt — the demo lives there.")
